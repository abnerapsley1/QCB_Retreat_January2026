...
The overall aim of a whole-cell model is to provide a comprehensive description of the cell state across a defined period of time (often the length of the cell cycle). The whole-cell model is comprised of a description of the cell state and the computational procedures that define how the cell state evolves over time. After being constructed, whole-cell models must be realized through the used of a combination of hardware, software, and computational pipelines. After whole-cell models have been realized and results have been generated, this data can be used to perform analyses, answer biological questions, visualize output, and compare output with experimental results.
